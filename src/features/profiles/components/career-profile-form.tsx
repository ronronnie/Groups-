...
export function CareerProfileForm({
  ...
  return (
    <form action={formAction} className="space-y-10">
      ...
      <div className="sticky bottom-4 z-20 -mx-2 flex border border-border bg-background/95 p-2 shadow-md backdrop-blur sm:static sm:mx-0 sm:border-0 sm:bg-transparent sm:p-0 sm:shadow-none">
        <Button
